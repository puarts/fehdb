...
class GeminiOCRBackend:
            ...
            try:
                if group.skill_cards:
                    ...
                    for card in group.skill_cards:
                        skill_data = self._call_vision_api_jp_single_card([card.image_path], ocr_hint=group.ocr_hint)
    ...
    def _call_vision_api_jp_single_card(self, frame_paths: list[str], ocr_hint: str | None = None) -> dict:
